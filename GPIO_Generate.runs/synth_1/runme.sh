...
HD_PWD='D:/All/Software/ZZ-Hardware/80-Vivado/01-PROJECT/GPIO_Generate/GPIO_Generate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_wrapper.tcl
