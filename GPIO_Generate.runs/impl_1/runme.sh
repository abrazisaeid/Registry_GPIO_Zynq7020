...
HD_PWD='D:/All/Software/ZZ-Hardware/80-Vivado/01-PROJECT/GPIO_Generate/GPIO_Generate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpio_wrapper.tcl -notrace
